...
class Drone:
    ...
    def get_pose(self):
        ...
        self.hlcontroller._x = onboard_estimate_world[0]
        self.hlcontroller._y = onboard_estimate_world[1]
        self.hlcontroller._z = onboard_estimate_world[2]
