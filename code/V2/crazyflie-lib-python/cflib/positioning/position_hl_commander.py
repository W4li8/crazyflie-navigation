...
## Added Methods #####################################################################
    ...
    def reset_pose_estimator(self):
        """ Reset Kalman pose estimator, to be done at takeoff """
    ...
    def goto_with_yaw(self, x, y, z=DEFAULT, yaw=0, velocity=DEFAULT):
        """ Modified library go_to to include yaw control """
